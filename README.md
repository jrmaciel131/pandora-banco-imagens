...
├── index.html                   markup principal + <link>/<script>
...
4. Preencher os valores reais em `private-config/config.php` nos lugares marcados com `SEU_*_AQUI` (DB, hashes de usuários, IDs do Sheets/Drive, CRON_KEY).
...
Detalhes completos em [DEPLOY.md](DEPLOY.md) e [UPGRADE-V21.md](UPGRADE-V21.md).
...
- [DEPLOY.md](DEPLOY.md) — passo a passo do deploy com hardening completo.
- [DOCUMENTACAO.md](DOCUMENTACAO.md) — referência técnica detalhada.
- [UPGRADE-V21.md](UPGRADE-V21.md) — guia da última versão (v21.1).
- [TUTORIAL-GITHUB-PARA-INICIANTE.md](TUTORIAL-GITHUB-PARA-INICIANTE.md) — para quem nunca usou Git.
